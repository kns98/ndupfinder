...
namespace deduper.win8store
{
    ...
    public class DockPanel : Panel
    {
        ...
        [SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters",
            Justification = "DockPanel only has UIElement children")]
        ...
        [SuppressMessage("Microsoft.Usage", "CA2208:InstantiateArgumentExceptionsCorrectly",
            Justification = "Almost always set from the attached property CLR setter.")]
        private static void OnDockPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            var panel = VisualTreeHelper.GetParent(element) as DockPanel;
